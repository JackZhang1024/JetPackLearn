...
public class PPDClassicHeader extends InternalClassics<com.scwang.smartrefresh.layout.header.ClassicsHeader> implements RefreshHeader {
...
//    public static String REFRESH_HEADER_UPDATE = "'Last update' M-d HH:mm";
    ...
    public PPDClassicHeader(Context context) {
        this(context, null);
    }

    public PPDClassicHeader(Context context, AttributeSet attrs) {
    ...
    public PPDClassicHeader setLastUpdateTime(Date time) {
        final View thisView = this;
        mLastTime = time;
    ...
    public PPDClassicHeader setTimeFormat(DateFormat format) {
    ...
    public PPDClassicHeader setLastUpdateText(CharSequence text) {
        mLastTime = null;
    ...
    public PPDClassicHeader setEnableLastTime(boolean enable) {
        final View updateView = mLastUpdateText;
    ...
    public PPDClassicHeader setTextSizeTime(float size) {
...
//    }
    ...
    public PPDClassicHeader setTextTimeMarginTop(float dp) {
        final View updateView = mLastUpdateText;
