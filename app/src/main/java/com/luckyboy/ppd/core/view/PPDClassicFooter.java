...
public class PPDClassicFooter extends InternalClassics<com.scwang.smartrefresh.layout.footer.ClassicsFooter> implements RefreshFooter {
    ...
    public PPDClassicFooter(Context context) {
        this(context, null);
    }
