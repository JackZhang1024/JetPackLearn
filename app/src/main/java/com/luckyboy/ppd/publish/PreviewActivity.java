...
import com.luckyboy.jetpacklearn.databinding.ActivityLayoutPreviewBinding;
...
public class PreviewActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static void startActivityForResult(
            Activity activity, String previewUrl,
            boolean isVideo, String btnText) {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPreviewBinding = DataBindingUtil.setContentView(this,
                R.layout.activity_layout_preview);
        String preViewUrl = getIntent().getStringExtra(KEY_PREVIEW_URL);
        boolean isVideo = getIntent().getBooleanExtra(KEY_PREVIEW_VIDEO,
                false);
